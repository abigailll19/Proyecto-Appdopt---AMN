...
import com.example.appdopt.core.data.repository.SupabaseAdoptionRepository
import com.example.appdopt.core.data.repository.SupabasePetRepository
import dagger.Binds
...
abstract class RepositoryModule {
    ...
    abstract fun bindPetRepository(
        supabasePetRepository: SupabasePetRepository
    ): PetRepository

    @Binds
    @Singleton
    abstract fun bindAdoptionRepository(
        supabaseAdoptionRepository: SupabaseAdoptionRepository
    ): AdoptionRepository
}
